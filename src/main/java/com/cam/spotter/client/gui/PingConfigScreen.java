package com.cam.spotter.client.gui;

import com.cam.spotter.client.PingClientConfig;
import com.cam.spotter.client.PingDirectionOverlay;
import com.cam.spotter.client.PingKeyMappings;
...
public class PingConfigScreen extends Screen {
    ...
    public PingConfigScreen(@Nullable Screen parent) {
        super(Component.translatable("screen.spotter.config.title"));
        this.parent = parent;
    ...
    protected void init() {
        ...
        y += SECTION_LABEL_H;
        addScrollableWidget(Checkbox.builder(Component.translatable("screen.spotter.config.show_beam"), font)
                .pos(contentLeft, y)
                .selected(PingClientConfig.SHOW_BEAM.get())
                .tooltip(Tooltip.create(Component.translatable("screen.spotter.config.show_beam.tooltip")))
                .onValueChange((cb, v) -> {
        ...
        addScrollableWidget(CycleButton
                .<PingClientConfig.HologramPosition>builder(p -> Component.translatable(
                        "screen.spotter.config.hologram_position." + p.name().toLowerCase()))
                .withValues(PingClientConfig.HologramPosition.values())
                .withInitialValue(PingClientConfig.HOLOGRAM_POSITION.get())
                .withTooltip(p -> Tooltip.create(Component.translatable("screen.spotter.config.hologram_position.tooltip")))
                .create(contentLeft, y, CONTENT_W, 20,
                        Component.translatable("screen.spotter.config.hologram_position"),
                        (b, v) -> {
        ...
        addScrollableWidget(Checkbox.builder(Component.translatable("screen.spotter.config.show_hostile_indicator"), font)
                .pos(contentLeft, y)
                .selected(PingClientConfig.SHOW_HOSTILE_INDICATOR.get())
                .tooltip(Tooltip.create(Component.translatable("screen.spotter.config.show_hostile_indicator.tooltip")))
                .onValueChange((cb, v) -> {
        ...
        y += SECTION_LABEL_H;
        addScrollableWidget(Checkbox.builder(Component.translatable("screen.spotter.config.show_target_name"), font)
                .pos(contentLeft, y)
                .selected(PingClientConfig.SHOW_TARGET_NAME.get())
                .tooltip(Tooltip.create(Component.translatable("screen.spotter.config.show_target_name.tooltip")))
                .onValueChange((cb, v) -> {
                ...
                .build());
        y += CHECKBOX_ROW;
        addScrollableWidget(Checkbox.builder(Component.translatable("screen.spotter.config.show_owner_name"), font)
                .pos(contentLeft, y)
                .selected(PingClientConfig.SHOW_OWNER_NAME.get())
                .tooltip(Tooltip.create(Component.translatable("screen.spotter.config.show_owner_name.tooltip")))
                .onValueChange((cb, v) -> {
                ...
                .build());
        y += CHECKBOX_ROW;
        addScrollableWidget(Checkbox.builder(Component.translatable("screen.spotter.config.show_player_head"), font)
                .pos(contentLeft, y)
                .selected(PingClientConfig.SHOW_PLAYER_HEAD.get())
                .tooltip(Tooltip.create(Component.translatable("screen.spotter.config.show_player_head.tooltip")))
                .onValueChange((cb, v) -> {
                ...
                .build());
        y += CHECKBOX_ROW;
        addScrollableWidget(Checkbox.builder(Component.translatable("screen.spotter.config.show_distance"), font)
                .pos(contentLeft, y)
                .selected(PingClientConfig.SHOW_DISTANCE.get())
                .tooltip(Tooltip.create(Component.translatable("screen.spotter.config.show_distance.tooltip")))
                .onValueChange((cb, v) -> {
        ...
        addRenderableWidget(Button.builder(
                Component.translatable("screen.spotter.config.reset"),
                b -> resetColor()
    ...
    private Component keybindLabel(KeyMapping km) {
        if (km == rebindingKey) {
            return Component.translatable("screen.spotter.config.rebinding")
                    .copy()
    ...
    public void renderBackground(GuiGraphics gui, int mouseX, int mouseY, float partialTick) {
        ...
        drawSectionLabel(gui, font, panelLeft + 20, previewSectionY,
                Component.translatable("screen.spotter.config.section.preview"));
        drawSectionLabel(gui, font, panelLeft + 20, colorSectionY,
                Component.translatable("screen.spotter.config.section.color"));
        drawSectionLabel(gui, font, panelLeft + 20, displaySectionY,
                Component.translatable("screen.spotter.config.section.display"));
        drawSectionLabel(gui, font, panelLeft + 20, labelSectionY,
                Component.translatable("screen.spotter.config.section.label"));
        drawSectionLabel(gui, font, panelLeft + 20, controlsSectionY,
                Component.translatable("screen.spotter.config.section.controls"));
        ...
        gui.drawCenteredString(
                font,
                Component.translatable("screen.spotter.config.server_hint"),
                this.width / 2,
