...
public class PingHudOverlay {
    private static final ResourceLocation LAYER_ID =
            ResourceLocation.fromNamespaceAndPath(PingMod.MODID, "cooldown_indicator");
    private static final ResourceLocation RING_TEX =
            ResourceLocation.fromNamespaceAndPath(PingMod.MODID, "textures/gui/circle.png");
    private static final ResourceLocation PROGRESS_TEX =
            ResourceLocation.fromNamespaceAndPath(PingMod.MODID, "textures/gui/progress.png");
